...
namespace VueFront
{
    public static class ViteHelper
    {
        ...
        public static void UseViteDevelopmentServer(this ISpaBuilder spa, int? port = 3000)
        {
            ...
            var devServerEndpoint = new Uri($"https://localhost:{port}");
